      ...
      <section className="section-padding pb-20">
        <div className="max-container max-w-3xl">
          <div className="space-y-10">
            ...
            {/* Section 1 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">1. Acceptance of Terms</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 2 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">2. Accounts</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 3 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">3. Mobile Messaging Terms &amp; Conditions</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed mb-4">
            ...
            {/* Section 4 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">4. Use of AI Services</h2>
            ...
            {/* Section 5 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">5. Intellectual Property</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 6 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">6. Fees and Payment</h2>
              <ul className="space-y-3">
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">6.1.</span> All pricing is outlined on the
                  Company&apos;s checkout page, order form, or in your service agreement.
                </li>
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">6.2.</span> All payments are strictly
                ...
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">6.3.</span> The Company reserves the right to
            ...
            {/* Section 7 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">7. Chargeback &amp; Dispute Policy</h2>
              <ul className="space-y-3">
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">7.1.</span> By using our Services, you agree not
                ...
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">7.2.</span> Initiating a chargeback without prior
            ...
            {/* Section 8 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">8. Results Disclaimer</h2>
              <ul className="space-y-3">
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">8.1.</span> We make no guarantees regarding
                  outcomes, revenue, or results. Your performance depends on your business model, effort,
                  and market conditions.
                </li>
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">8.2.</span> Templates, frameworks, and strategies
            ...
            {/* Section 9 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">9. Use of Templates and Frameworks</h2>
              <ul className="space-y-3">
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">9.1.</span> Our programs include proprietary
                  templates, prompts, and frameworks used across client accounts for efficiency and faster deployment.
                </li>
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">9.2.</span> These tools are customisable and
            ...
            {/* Section 10 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">10. Client Responsibilities</h2>
              <ul className="space-y-3">
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">10.1.</span> You agree to participate fully in
                  your program by attending calls, completing assigned tasks, implementing instructions, and
                  maintaining communication.
                </li>
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">10.2.</span> Failure to engage, implement, or
            ...
            {/* Section 11 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">11. Termination</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 12 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">12. Limitation of Liability</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed mb-4">
            ...
            {/* Section 13 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">13. Disclaimer of Warranties</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 14 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">14. Governing Law</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 15 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">15. Changes</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 16 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">16. Contact Us</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed mb-4">
                If you have any questions about these Terms, please contact us at:
              </p>
              <div className="space-y-2">
                <p className="text-white/80">
                  <span className="text-[#EDECE4] font-normal">Email:</span>{" "}
                  <a href="mailto:support@novadatech.com.au" className="text-[#0CC481] hover:text-white transition-colors">
                    support@novadatech.com.au
                  </a>
                </p>
                <p className="text-white/80">
                  <span className="text-[#EDECE4] font-normal">Phone:</span>{" "}
                  <a href="tel:+61485000813" className="text-[#0CC481] hover:text-white transition-colors">
                    (+61) 485 000 813
                  </a>
                </p>
                <p className="text-white/80">
                  <span className="text-[#EDECE4] font-normal">Address:</span>{" "}
            ...
            {/* Section 17 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">17. Privacy Policy</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
                Please review our full privacy policy at:{" "}
                <Link href="/privacy-policy" className="text-[#0CC481] hover:text-white transition-colors">
