...
/*
 * /meetings-b — EMBER-SKINNED A/B VARIANT of /meetings (Facebook ads
 * split test). Content, structure and copy are byte-identical to the
 * green variant — ONLY the visual skin differs (dark-ember system:
 * Inter bold, vermilion #FF5A30 accents, glass cards, warm glows,
 * pill CTAs). Keep both variants' copy in lockstep: any copy change
 * to /meetings must be mirrored here.
 *
...
const BTN_CTA =
  "inline-flex items-center justify-center gap-2 rounded-full bg-ember-500 px-8 py-4 text-base font-bold text-white transition-all hover:bg-ember-400 hover:shadow-[0_0_40px_rgba(255,90,48,0.4)]";
const BTN_CTA_SM =
  "inline-flex items-center justify-center gap-2 rounded-full bg-ember-500 px-5 py-2.5 text-sm font-bold text-white transition-colors hover:bg-ember-400";
const GRAD_TEXT =
  "bg-gradient-to-r from-white to-ember-500 bg-clip-text text-transparent";

/* ─── HEADER (minimal — logo + CTA only) ─── */
function Header() {
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#080808]/95 backdrop-blur-xl border-b border-[#ffffff]/10">
...
function Hero() {
  return (
    <section className="relative pt-10 pb-8 md:pt-16 md:pb-10 overflow-hidden">
      <div className="absolute inset-x-0 top-0 h-[80vh] bg-[linear-gradient(180deg,#1c120c_0%,rgba(10,10,10,0)_100%)] pointer-events-none" />
      ...
      <div className="relative max-container section-padding text-center">
        <motion.p
          ...
          className="text-[11px] md:text-xs uppercase tracking-[0.2em] text-ember-500 mb-5"
        >
        ...
        <motion.p
          ...
          className="mt-5 text-base md:text-xl text-[#ffffff]/95 max-w-2xl mx-auto leading-relaxed"
        >
        ...
        >
          ...
          <p className="mt-4 text-sm md:text-base text-[#ffffff]/90">
          ...
          <p className="mt-3 text-[10px] uppercase tracking-[0.15em] text-[#ffffff]/40">
  ...
  return (
    <section className="section-padding pt-2 pb-14 md:pb-20">
      <div className="max-container max-w-3xl">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-3 text-sm text-[#ffffff]/80">
            <Play className="w-3.5 h-3.5 text-ember-500" />
            <span>Watch the 2-minute overview</span>
          </div>
          <div
            className="relative rounded-xl overflow-hidden border border-ember-500/25 shadow-[0_0_60px_rgba(255,90,48,0.12)]"
          ...
          <div className="mt-3 flex items-center justify-center gap-2 text-xs text-[#ffffff]/50">
            <span>Presented by <span className="text-[#ffffff]/70">Ade</span> — Founder, Novada Tech</span>
          </div>
        </motion.div>
      </div>
    </section>
    ...
    <section className="section-padding pb-16 md:pb-24">
      <div className="max-container max-w-5xl">
        <AnimatedSection className="text-center mb-10">
          <p className="text-[11px] uppercase tracking-[0.2em] text-ember-500 mb-4">
            ...
            <AnimatedSection key={c.id} delay={(i % 2) * 0.08}>
              <div className="glass-card gradient-border rounded-2xl overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <p className="mt-1.5 text-[10px] uppercase tracking-[0.15em] text-[#ffffff]/45">
                    {c.who}
                  </p>
                </div>
              </div>
...
function BurnedBefore() {
  ...
  return (
    <section className="section-padding py-16 md:py-24 border-t border-[#ffffff]/10">
      <div className="max-container max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          <AnimatedSection>
            <div className="rounded-xl border border-[#ffffff]/[0.08] p-7 h-full">
              <p className="text-[11px] uppercase tracking-[0.15em] text-[#ffffff]/40 mb-5">
              ...
              <div className="space-y-4">
                {oldWay.map((item, i) => (
                  <div key={i} className="flex items-start gap-3">
                    ...
                    <p className="text-base text-[#ffffff]/90 leading-relaxed">{item}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <AnimatedSection delay={0.1}>
            <div className="rounded-2xl border border-ember-500/30 bg-gradient-to-br from-ember-500/[0.06] to-transparent p-7 h-full">
              <p className="text-[11px] uppercase tracking-[0.15em] text-ember-500 mb-5">
                How we work
              </p>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-ember-500 mt-0.5 flex-shrink-0" strokeWidth={1.5} />
                    <p className="text-base text-[#ffffff] leading-relaxed">{item}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <AnimatedSection delay={0.15} className="text-center mt-8">
          <p className="text-lg md:text-xl text-[#ffffff]/95 max-w-2xl mx-auto leading-relaxed">
  ...
  return (
    <section className="section-padding py-14 md:py-20">
      <div className="max-container max-w-2xl">
        <AnimatedSection>
          <div className="border-l-2 border-ember-500 pl-6 md:pl-8">
            <p className="text-[11px] uppercase tracking-[0.2em] text-ember-500 mb-4">
            ...
            <p className="text-[10px] uppercase tracking-[0.15em] text-[#ffffff]/40 mt-1">
    ...
    <section className="section-padding py-16 md:py-24">
      <div className="max-container max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {cards.map((c, i) => (
            <AnimatedSection key={i} delay={i * 0.08}>
              <div className="glass-card gradient-border rounded-2xl p-7 h-full text-center">
                <c.icon className="w-8 h-8 text-ember-500 mx-auto mb-4" strokeWidth={1.3} />
                <h3 className="text-lg font-normal text-white mb-2">{c.title}</h3>
                <p className="text-sm text-[#ffffff]/85 leading-relaxed">{c.desc}</p>
              </div>
            </AnimatedSection>
          ))}
        </div>
        ...
        <AnimatedSection delay={0.2} className="text-center mt-10">
          ...
          <p className="mt-4 text-[10px] uppercase tracking-[0.15em] text-[#ffffff]/40">
    ...
    <section className="section-padding py-16 md:py-24 border-t border-[#ffffff]/10">
      <div className="max-container max-w-4xl">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="mt-4 text-base md:text-lg text-[#ffffff]/90 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="space-y-5">
          <AnimatedSection>
            <div className="glass-card gradient-border rounded-2xl p-7 md:p-9 flex flex-col md:flex-row gap-5 md:items-center">
              <span className="font-poppins italic font-extralight text-6xl md:text-7xl leading-none bg-gradient-to-b from-[#571e0c] to-ember-500 bg-clip-text text-transparent select-none flex-shrink-0 px-2">
                1
              </span>
              <div>
                ...
                <p className="text-base text-[#ffffff]/90 leading-relaxed">
        ...
        <AnimatedSection delay={0.15} className="mt-8 text-center">
          <div className="inline-flex items-center gap-3 rounded-lg border border-[#ffffff]/10 px-5 py-3">
            <Clock className="w-4 h-4 text-ember-500" />
            <span className="text-sm text-[#ffffff]/95">
    ...
    <section className="section-padding py-16 md:py-24">
      <div className="max-container max-w-5xl">
        ...
        <div className="relative">
          <div className="hidden md:block absolute top-6 left-[16.67%] right-[16.67%] border-t border-dashed border-[#ffffff]/15" />
          <div className="grid md:grid-cols-3 gap-y-10 md:gap-x-6">
            {steps.map((s, i) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                <div className="relative text-center px-4">
                  <div className="relative z-10 mx-auto w-12 h-12 rounded-full border border-ember-500/60 bg-[#080808] flex items-center justify-center mb-5">
                    <span className="text-ember-500 text-sm">{i + 1}</span>
                  </div>
                  <p className="text-[10px] uppercase tracking-[0.18em] text-[#ffffff]/45 mb-2">
                    {s.period}
                  </p>
                  <h3 className="text-lg md:text-xl font-normal text-white mb-3">{s.title}</h3>
                  <p className="text-sm md:text-base text-[#ffffff]/80 leading-relaxed max-w-[300px] mx-auto">
                    {s.desc}
                  </p>
                </div>
              </AnimatedSection>
...
function Stats() {
  ...
  return (
    <section className="section-padding py-14 md:py-20 border-t border-b border-[#ffffff]/10">
      <div className="max-container max-w-5xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-10 gap-x-4 text-center">
          {stats.map((s, i) => (
            ...
            >
              ...
              <p className="mt-3 text-[10px] md:text-xs uppercase tracking-[0.18em] text-[#ffffff]/40">
                {s.label}
              </p>
            </motion.div>
          ))}
    ...
    <section className="section-padding py-16 md:py-24">
      <div className="max-container max-w-4xl">
        <div className="grid md:grid-cols-2 gap-6">
          {quotes.map((t, i) => (
            <AnimatedSection key={i} delay={i * 0.1}>
              <figure className="glass-card gradient-border rounded-2xl p-7 h-full flex flex-col">
                <div className="text-ember-500 text-sm tracking-widest mb-4">★★★★★</div>
                <blockquote className="text-base md:text-lg text-[#ffffff] leading-relaxed flex-1">
                  &ldquo;{t.quote}&rdquo;
                </blockquote>
                <figcaption className="mt-6 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] uppercase tracking-[0.15em] text-[#ffffff]/40">{t.role}</p>
                  </div>
                </figcaption>
              </figure>
            </AnimatedSection>
...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-[#ffffff]/10">
      ...
      >
        <span className="text-base md:text-lg text-[#ffffff] group-hover:text-white transition-colors pr-4">
          {question}
        </span>
        <ChevronDown
          className={`w-5 h-5 text-[#ffffff]/50 flex-shrink-0 transition-transform duration-300 ${open ? "rotate-180" : ""}`}
        />
      </button>
      <motion.div
        initial={false}
      ...
      >
        <p className="pb-6 text-base text-[#ffffff]/90 leading-relaxed">{answer}</p>
      </motion.div>
    </div>
  );
}
...
function Booking() {
  ...
  return (
    <section id="book" className="relative section-padding py-16 md:py-24 overflow-hidden">
      <div className="absolute inset-0 bg-[linear-gradient(0deg,rgba(199,56,21,0.35)_0%,rgba(199,56,21,0)_55%)] pointer-events-none" />
      <div className="relative max-container max-w-5xl">
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          ...
          <AnimatedSection direction="left" className="lg:col-span-1">
            <div className="glass-card gradient-border rounded-2xl p-7 lg:sticky lg:top-24">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-ember-500 mt-0.5 flex-shrink-0" strokeWidth={1.5} />
                    <span className="text-sm text-[#ffffff]/95 leading-relaxed">{item}</span>
                  </div>
                ))}
              </div>
              <div className="mt-6 pt-5 border-t border-[#ffffff]/[0.08] text-[10px] uppercase tracking-[0.15em] text-[#ffffff]/40 leading-relaxed">
          ...
          <div className="lg:col-span-2">
            <div className="rounded-2xl border border-ember-500/25 bg-white/[0.02] p-2 min-h-[600px] relative z-10">
              <iframe
    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-50 bg-[#080808]/95 backdrop-blur-xl border-t border-[#ffffff]/10 py-3 px-5 sm:px-8"
        >
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
            <div className="hidden sm:block">
              ...
              <p className="text-[10px] uppercase tracking-[0.15em] text-[#ffffff]/40">
...
/* ─── PAGE ─── */
export default function MeetingsLanderEmberPage() {
  return (
    <div className="bg-surface-950 overflow-x-clip">
      <Header />
      <Hero />
      <VSL />
      <VideoCaseStudies />
