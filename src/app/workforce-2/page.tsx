...
/*
 * /workforce-2 — US-market duplicate of /workforce (2026-08-20): American terminology (caregiver, CNA, per-diem/PRN, schedule not schedule), US spellings, US phone. Novada Workforce single-page conversion lander (AU, B2B).
 ...
 *  - NOT positioned as a call center / answering service / VA / outsourcing.
  ...
  return (
    <div className={`${CARD} p-5 md:p-6 shadow-[0_24px_80px_rgba(12,196,129,0.12)]`}>
      ...
      <div className="mt-4 pt-4 border-t border-[#EDECE4]/[0.08] space-y-2">
        {[
          ["Schedule checked, eligible workers identified", "10:50 PM"],
          ["6 approved workers contacted", "10:52 PM"],
          ["Replacement accepted the shift", "11:01 PM"],
          ["Client informed · schedule updated", "11:04 PM"],
        ].map(([step, time]) => (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-10 items-center">
          <div>
            <motion.p
              ...
              className={EYEBROW}
            >
              After-Hours Workforce Operations · U.S. Healthcare, Home Care &amp; Senior Care Providers
            </motion.p>
            <motion.h1
            ...
            >
              Built for U.S. healthcare, home care and senior care providers.
            </motion.p>
          </div>
...
const SCENARIOS = [
  ...
  },
  {
    ...
    quote: "“We need another CNA for the 7am shift.”",
    detail:
...
const SERVICES = [
  ...
  {
    title: "No-Shows & Late Caregivers",
    desc: "We chase the worker, find out what is happening, keep everyone informed and line up cover if it is needed.",
    icon: UserX,
  },
  {
    title: "Client Communication",
    desc: "We keep facilities and authorized client contacts in the loop, so nobody is left waiting for your office to open.",
    icon: PhoneCall,
  },
  {
        ...
        <AnimatedSection delay={0.15}>
          <div className="mt-8 rounded-xl border border-[#0CC481]/25 bg-[#0CC481]/[0.04] p-6 md:p-7 text-center">
            ...
            <p className={`text-sm md:text-base ${BODY} max-w-2xl mx-auto leading-relaxed`}>
              Novada Workforce does not replace your scheduling platform. Our coordinators log in to the systems you already use and work them the way your team does.
            </p>
          </div>
        </AnimatedSection>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-5 mb-12">
          ...
          <AnimatedSection delay={0.16}>
            <div className={`${CARD} p-7 h-full text-center`}>
              ...
              <p className="text-sm text-[#EDECE4]/70 leading-relaxed">
                Worker outreach, client updates and schedule changes are done by
        ...
        <AnimatedSection delay={0.1}>
          <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <p className="text-lg md:text-xl text-[#EDECE4] leading-relaxed">
              ...
              software or handing your clients to a call center. It means
...
const WORKFLOW = [
  ...
  { title: "Shift identified", detail: "Client's existing schedule checked." },
  ...
  { title: "Schedule updated", detail: "Client's existing system remains the source of truth." },
          ...
          <div className="grid md:grid-cols-[1fr_auto_1fr] gap-4 items-stretch">
            <div className={`${CARD} p-6`}>
              ...
              <div className="space-y-2.5">
                {["Scheduling Platform", "Worker Database", "Client Records"].map((s) => (
    ...
    <section className="section-padding py-16 md:py-24 border-t border-[#EDECE4]/[0.07]">
      <div className="max-container max-w-4xl">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className={`mt-4 text-base md:text-lg ${BODY} max-w-2xl mx-auto leading-relaxed`}>
            Our coordinators do what you have authorized, the way you have documented it, and bring everything else to you.
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.15}>
          <p className={`mt-8 text-center text-sm md:text-base ${BODY} max-w-2xl mx-auto`}>
            Your organization maintains authority over clinical, employment,
      ...
      <div className="max-container max-w-4xl">
        ...
        <AnimatedSection>
          ...
          <p className={`mt-8 text-center text-base ${BODY} max-w-2xl mx-auto`}>
            Particularly suited to providers and staffing agencies delivering per-diem, PRN, urgent, same-day or 24/7 workforce coverage.
          </p>
        </AnimatedSection>
      </div>
    </section>
...
function Qualification() {
  const fit = [
    "You provide per-diem, PRN or shift-based caregivers or nurses.",
  ...
  const notFit = [
    "You only do permanent placement.",
    ...
    <section className="section-padding py-16 md:py-24">
      <div className="max-container max-w-4xl">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className={H2}>Is Novada Workforce right for your organization?</h2>
        </AnimatedSection>
...
function Security() {
  const items = [
    {
      title: "Only Authorized Coordinators",
      desc: "Named, authorized coordinators receive access, scoped to exactly what you approve.",
      icon: Lock,
    },
    {
...
const FAQS = [
  {
    q: "Does Novada replace our scheduling software?",
    a: "No. You keep the scheduling system you have today. Our coordinators log in with the access you approve and work it the way your team does. The only thing that changes is who is doing the work at night.",
  },
  {
    q: "Do you simply answer our after-hours calls?",
    a: "No. Taking the message is where our work starts, not where it ends. Our coordinators actually fill the shift: they contact your workers, arrange the replacement, update your client and your schedule, and write it all down for the morning.",
  },
  {
  ...
  {
    q: "Can you work with our existing schedule platform?",
  ...
  {
    q: "Is this suitable for permanent placement agencies?",
    a: "Generally not. Novada Workforce is primarily designed for businesses managing per-diem, PRN or shift-based caregivers and nurses.",
  },
];
...
const fmtAud = (n: number) => `$${Math.round(n).toLocaleString("en-US")}`;
      ...
      <div className="relative max-container max-w-5xl text-center">
        ...
        <AnimatedSection delay={0.15}>
          ...
          <p className="font-supply mt-5 text-[10px] md:text-[11px] uppercase tracking-[0.15em] text-[#EDECE4]/40">
            Designed for U.S. healthcare, home care and senior care providers.
          </p>
        </AnimatedSection>
      </div>
    </section>
