...
function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative max-container section-padding pt-32 pb-16 md:pt-36 md:pb-20">
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-center">
          ...
          <div>
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl font-bold leading-[1.1] tracking-tight text-balance"
            >
            ...
            >
              If we don&apos;t generate revenue, you don&apos;t pay us. No retainers. No ad spend required. No risk.
            </motion.p>
            ...
            <motion.div
              ...
              className="mt-8 pt-8 border-t border-white/[0.06] grid grid-cols-3 gap-4"
            >
              {[
                { day: "Day 1–3", label: "Offer refined & engine architected" },
                { day: "Day 4–7", label: "Targeting, messaging & outreach live" },
                { day: "Day 8–14", label: "First qualified meetings in your calendar" },
              ].map((item, i) => (
                <div key={i}>
          ...
          >
            ...
            <p className="mt-3 text-xs text-white/25 text-center uppercase tracking-widest">
              Watch: How we generate high-value clients for businesses like yours
            </p>
          </motion.div>
