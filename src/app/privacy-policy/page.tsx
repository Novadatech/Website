      ...
      <section className="section-padding pb-20">
        <div className="max-container max-w-3xl">
          <div className="prose-policy space-y-10">
            ...
            {/* Section 1 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">1. Information We Collect</h2>
              ...
              <ul className="space-y-3">
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">Personal Data:</span> Information such as your
                ...
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">Usage Data:</span> Information about how you
                  interact with our website or Services, such as IP address, browser type, pages visited,
                  and time spent on the site.
                </li>
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">Cookies:</span> We may use cookies and similar
                  tracking technologies to enhance your experience. You can manage cookie preferences
                  through your browser settings.
                </li>
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">SMS Data:</span> If you opt into our SMS
                  program, we collect your phone number and any information you provide via text messages.
                </li>
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">Social Media Data:</span> If you choose to link
            ...
            {/* Section 2 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">2. How We Use Your Information</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed mb-4">
            ...
            {/* Section 3 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">3. SMS Program Terms</h2>
            ...
            {/* Section 4 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">4. Sharing Your Information</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed mb-4">
            ...
            {/* Section 5 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">5. Security of Your Information</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 6 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">6. Your Choices</h2>
              <ul className="space-y-3">
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">Opt-Out:</span> You may unsubscribe from
                ...
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">Cookies:</span> You can disable cookies via
                  your browser settings, though this may affect website functionality.
                </li>
                <li className="font-light text-[#EDECE4]/75 leading-relaxed">
                  <span className="text-[#EDECE4] font-normal">Data Compliance:</span> You are responsible
            ...
            {/* Section 7 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">7. Data Deletion</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 8 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">8. Third-Party Links</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 9 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">9. Intellectual Property Notice</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 10 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">10. Changes to This Privacy Policy</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
            ...
            {/* Section 11 */}
            <div>
              <h2 className="text-xl font-normal text-[#EDECE4] mb-4">11. Contact Us</h2>
              <p className="font-light text-[#EDECE4]/75 leading-relaxed">
