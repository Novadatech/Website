...
/*
 * Growth Infrastructure — the home page's Morningside spine carrying the
 * GI offer:
 * hero → industries marquee → pinned scroll problem narrative → "three
 * things" giant-numeral journey cards (Authority / Outreach / Booked) →
 * VSL → quote testimonials → stats marquee → grayscale case-study
 * thumbnails → FAQ → gradient closer.
 */
...
const GI_CASE_STUDIES = CASE_STUDIES.filter(
  ...
  return (
    <section className="relative pt-16 pb-16 md:pt-24 md:pb-20 overflow-hidden">
      ...
      <div className="relative max-container section-padding text-center">
        ...
        >
          Growth Infrastructure&trade; — For B2B Businesses That Want To Scale
        </motion.p>
...
const PROBLEM_STATEMENTS = [
  {
    text: "You're sending more outreach than ever. Cold emails. Connection requests. Follow-ups.",
    final: false,
  },
  {
    text: "But prospects look you up, see nothing that says expert — and archive you in three seconds.",
    final: false,
  },
  {
  ...
  {
    text: "Outbound isn't broken. You're running the 2020 playbook in a 2026 inbox.",
    final: false,
  },
  {
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-12">
                  ...
                  <div>
                    ...
                    <p className="mt-4 text-base md:text-xl font-light text-[#EDECE4]/85 leading-relaxed">
                      ...
                      social, video and short-form channels. When prospects research
...
function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: "We produce 4 – 6 short videos per month featuring you, edited for social and short-form distribution. We write the scripts around your expertise, produce them remotely (you record from anywhere), and distribute across the channels your buyers actually use. The result is a compounding authority asset that pre-sells before outreach ever lands.",
    },
    {
    ...
    },
    {
      ...
      a: "An in-house SDR costs $80K – $120K loaded, takes 3 – 6 months to ramp, and quits inside 12 months. DIY means juggling content, outreach, reply handling, qualification and booking on top of delivery — which is why most founders abandon outbound within 90 days. We install a system that costs less than a single SDR, launches in 14 days, never quits, and carries a written performance guarantee.",
    },
    {
      q: "What if I'm in a small or niche industry?",
      a: "Niche is exactly where this approach wins. The smaller and more defined your ICP, the easier it is to dominate your niche through authority + targeted outreach. We've installed this in 30+ industries from healthcare to B2B SaaS to coaching to professional services.",
    },
    {
